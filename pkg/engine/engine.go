...
func (e *Engine) renderSingle(t *template.Template, name string, vals chartutil.Values, buf *bytes.Buffer) (string, error) {
	buf.Reset()
...
func (e *Engine) renderFromSpec(spec *renderSpec) (map[string]string, error) {
