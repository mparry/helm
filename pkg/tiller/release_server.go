...
func (s *ReleaseServer) renderResources(ch *chart.Chart, values chartutil.Values, expandVals bool, vs chartutil.VersionSet) ([]*release.Hook, *bytes.Buffer, string, *chart.Config, error) {
