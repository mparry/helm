...
type UpdateReleaseRequest struct {
	...
	// Expand any templates found in values.
	ExpandValues bool `protobuf:"varint,12,opt,name=expand_values,json=expandValues" json:"expand_values,omitempty"`
}
...
func (m *UpdateReleaseRequest) GetExpandValues() bool {
	if m != nil {
...
type InstallReleaseRequest struct {
	...
	Wait bool `protobuf:"varint,9,opt,name=wait" json:"wait,omitempty"`
	// Expand any templates found in values.
	ExpandValues bool `protobuf:"varint,10,opt,name=expand_values,json=expandValues" json:"expand_values,omitempty"`
}
...
func (m *InstallReleaseRequest) GetExpandValues() bool {
	if m != nil {
		return m.ExpandValues
	}
	return false
...
var fileDescriptor0 = []byte{
	...
	,
}
